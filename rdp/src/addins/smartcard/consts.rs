...
pub(crate) const SCARD_IOCTL_GETTRANSMITCOUNT: u32 = 0x0009_0100;
pub(crate) const SCARD_IOCTL_GETREADERICON: u32 = 0x0009_0104;
pub(crate) const SCARD_IOCTL_GETDEVICETYPEID: u32 = 0x0009_0108;
pub(crate) const SCARD_IOCTL_READCACHEA: u32 = 0x0009_00F0;
pub(crate) const SCARD_IOCTL_READCACHEW: u32 = 0x0009_00F4;
pub(crate) const SCARD_IOCTL_WRITECACHEA: u32 = 0x0009_00F8;
pub(crate) const SCARD_IOCTL_WRITECACHEW: u32 = 0x0009_00FC;
...
pub(crate) fn ioctl_name(ioctl: u32) -> &'static str {
    match ioctl {
        ...
        SCARD_IOCTL_READCACHEA => "READ_CACHE_A",
        SCARD_IOCTL_READCACHEW => "READ_CACHE_W",
        SCARD_IOCTL_WRITECACHEA => "WRITE_CACHE_A",
        SCARD_IOCTL_WRITECACHEW => "WRITE_CACHE_W",
        _ => "UNKNOWN",
    }
}
